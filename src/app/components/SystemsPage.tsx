        ...
        render: () => (
          <div className="grid gap-4 grid-cols-1 md:grid-cols-3">
            {[
              {
                title: 'Extract',
                items: ['DB / APIs / Files', 'Config-driven sources', 'Deterministic input state'],
              },
              {
                title: 'Transform',
                items: [
...
export function SystemsPage({
  ...
  return (
    ...
    <p className="text-muted-foreground mb-6 text-sm">
      <span className="text-primary">{">"}</span>{" "}
      Explorative system design notes from personal projects—shared as thoughts and patterns, not as final recommendations.
    </p>
