...
export function playMechClick() {
  ...
  playSound("BTN_MECH", 0.1, navPitch);
...
export function startHoverNoise(volume = 0.6) {
...
export function startStatic(volume = 0.08) {
  startLoop(
    "STATIC",
    (src, gain) => {
      staticSource = src;
...
export function startTypingLoop(volume = 0.10) {
  startLoop(
    "TYPING",
    (src, gain) => {
      typingSource = src;
